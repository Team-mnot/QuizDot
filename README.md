<div align="center">
  <br />
  <img src="./assets/Stickey_logo.png" alt="QuizDot LOGO" width="165px" height="80px" />
  <br />
  <h2>퀴즈 게임 한 줄 요약, QuizDot</h2>
...
QuizDot 서비스 설명. QuizDot 서비스 설명.<br/>
QuizDot 서비스 설명. QuizDot 서비스 설명.<br/>
...
<tr>
  <td style="text-align:center;">캐릭터 뽑기</td>
  <td>캐릭터 뽑기 소개.</td>
</tr>
...
<img src="./assets/architecture.png" alt="아키텍처" width="1000px" />
...
<table style="border: 2px; text-align:center;">
  ...
  <tr>
   <td>
     <img src="./assets/회원가입.gif" alt="=" width="200px" />
    </td>
    <td>

...
export function ChattingBox() {
  ...
  return (
    <div className="fixed bottom-3 left-0 right-0 mx-auto max-w-3xl rounded-3xl bg-white p-4 bg-opacity-80">
      {/* 채팅 메시지 표시 영역 */}
      <div
      ...
      <div className="flex w-full">
        ...
        <input
          ...
          className="chat-input flex-grow rounded-l-md border border-gray-300 pl-4"
